...
| H4 | The caption's first line is a standalone number or dare, built to be quote-posted. | captions | regex now, LLM later | < 85% of first lines |
...
- H4 rejected as written (5/9). Refinement to test: "a figure appears within the first three lines".
...
## Candidate headlines (pick one in Phase 4, after Phase 2 tightens the tags)
